...
public class StringUtil {
    ...
    public static String doubleTicksToQuote(final String originalString) {
        ...
        return newString.replace(DOUBLE_TICKS, DOUBLE_QUOTES);
    }

    public static String replaceArguments(String naturalLanguageTemplate, final List<String> arguments) {
        naturalLanguageTemplate = naturalLanguageTemplate.replace("'", "''");
        return MessageFormat.format(naturalLanguageTemplate, arguments.toArray());
    }
