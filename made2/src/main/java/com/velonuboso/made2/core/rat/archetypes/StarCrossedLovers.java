 ...
 * @author rhgarcia
 */
public class StarCrossedLovers extends Archetype{

    @Override
    public String getArchetypeName() {
        return "Star-Crossed lovers";
    }

    @Override
    public String getDescription() {
        return "These two character are engaged in a love affair that is "
                + "fated to end in tragedy for one or both due to the "
