 ...
 * @author rhgarcia
 */
public class DamselInDistress extends Archetype{


    @Override
    public String getDescription() {
        return "This vulnerable woman must be rescued by the hero. She also "
                + "may be used as a trap, by an evil figure, to ensnare the "
                + "hero.";
    }
