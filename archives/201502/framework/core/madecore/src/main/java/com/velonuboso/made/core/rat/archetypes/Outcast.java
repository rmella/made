 ...
 * @author rhgarcia
 */
public class Outcast extends Archetype{


    @Override
    public String getDescription() {
        return "This figure is banished from a community for some crime (real "
                + "or imagined). The outcast is usually destined to become a "
                + "wanderer.";
    }
